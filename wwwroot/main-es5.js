(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var RegisService = /** @class */ (function () {
                function RegisService(http) {
                    this.http = http;
                    this.baseUrl = 'http://localhost:5000/api/';
                }
                RegisService.prototype.registerMahasiswa = function (model) {
                    return this.http.post(this.baseUrl + 'mahasiswa', model);
                };
                RegisService.prototype.registerDosen = function (model) {
                    return this.http.post(this.baseUrl + 'dosen', model);
                };
                RegisService.prototype.registerMataKuliah = function (model) {
                    return this.http.post(this.baseUrl + 'matakuliah', model);
                };
                RegisService.prototype.registerPerkuliahan = function (model) {
                    return this.http.post(this.baseUrl + 'perkuliahan', model);
                };
                return RegisService;
            }());
            RegisService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailMahasiswaComponent = /** @class */ (function () {
                function DetailMahasiswaComponent(http, alertify) {
                    this.http = http;
                ...
                DetailMahasiswaComponent.prototype.ngOnInit = function () {
                    this.getDetailMahasiswa();
                    this.getperkuliahanMahasiswa();
                };
                DetailMahasiswaComponent.prototype.getDetailMahasiswa = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'mahasiswa/' + this.idFromMahasiswa).subscribe(function (respose) {
                        _this.model = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                DetailMahasiswaComponent.prototype.getperkuliahanMahasiswa = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'perkuliahan/mhs/' + this.idFromMahasiswa).subscribe(function (respose) {
                        _this.modelperkuliahan = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                DetailMahasiswaComponent.prototype.cancel = function () {
                    this.cancelRegister.emit(false);
                };
                return DetailMahasiswaComponent;
            }());
            DetailMahasiswaComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            var DosenComponent = /** @class */ (function () {
                function DosenComponent(http, alertify) {
                    this.http = http;
                    this.alertify = alertify;
                    this.baseUrl = 'http://localhost:5000/api/';
                    this.registerModeDosen = false;
                }
                DosenComponent.prototype.ngOnInit = function () {
                    this.getDosen();
                };
                DosenComponent.prototype.getDosen = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'dosen').subscribe(function (respose) {
                        _this.dosens = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                DosenComponent.prototype.registerToggle = function () {
                    return this.registerModeDosen = true;
                };
                DosenComponent.prototype.deleteDosen = function (id) {
                    var _this = this;
                    return this.http.delete(this.baseUrl + 'dosen/' + id).subscribe(function () {
                        _this.alertify.error('Dosen Dihapus');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.getDosen();
                ...
                DosenComponent.prototype.cancelRegisterMode = function (registerMode) {
                    this.registerModeDosen = registerMode;
                };
                return DosenComponent;
            }());
            DosenComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            var EditMahasiswaComponent = /** @class */ (function () {
                function EditMahasiswaComponent(http, alertify) {
                    this.http = http;
                    this.alertify = alertify;
                    this.baseUrl = 'http://localhost:5000/api/';
                ...
                EditMahasiswaComponent.prototype.ngOnInit = function () {
                    this.getDetailMahasiswa();
                };
                EditMahasiswaComponent.prototype.getDetailMahasiswa = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'mahasiswa/' + this.idFromMahasiswaToEdit).subscribe(function (respose) {
                        _this.model = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                EditMahasiswaComponent.prototype.editMahasiswa = function () {
                    var _this = this;
                    this.http.put(this.baseUrl + 'mahasiswa/' + this.idFromMahasiswaToEdit, this.model).subscribe(function () {
                        _this.alertify.success('Mahasiswa Dirubah');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.updateMahasiswa.emit();
                        _this.cancelEdit.emit(false);
                    });
                };
                EditMahasiswaComponent.prototype.cancel = function () {
                    this.cancelEdit.emit(false);
                };
                return EditMahasiswaComponent;
            }());
            EditMahasiswaComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditPerkuliahanComponent = /** @class */ (function () {
                function EditPerkuliahanComponent(http, regisService, alertify) {
                    this.http = http;
                ...
                EditPerkuliahanComponent.prototype.ngOnInit = function () {
                    this.getPerkuliahan();
                    this.getMahasiswa();
                    this.getMataKuliah();
                    this.getDosen();
                };
                EditPerkuliahanComponent.prototype.getPerkuliahan = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'perkuliahan/' + this.idFromPerkuliahanForEdit).subscribe(function (respose) {
                        _this.model = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                EditPerkuliahanComponent.prototype.editPerkuliahan = function () {
                    var _this = this;
                    this.http.put(this.baseUrl + 'perkuliahan/' + this.idFromPerkuliahanForEdit, this.model).subscribe(function () {
                        _this.alertify.success('Perkuliahan Dirubah');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.updatePerkuliahan.emit();
                        _this.cancelEdit.emit(false);
                    });
                };
                EditPerkuliahanComponent.prototype.getMahasiswa = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'mahasiswa').subscribe(function (respose) {
                        _this.mahasiswaModel = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                EditPerkuliahanComponent.prototype.getMataKuliah = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'matakuliah').subscribe(function (respose) {
                        _this.mataKuliahModel = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                EditPerkuliahanComponent.prototype.getDosen = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'dosen').subscribe(function (respose) {
                        _this.dosenModel = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                EditPerkuliahanComponent.prototype.cancel = function () {
                    this.cancelEdit.emit(false);
                };
                return EditPerkuliahanComponent;
            }());
            EditPerkuliahanComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MahasiswaComponent = /** @class */ (function () {
                function MahasiswaComponent(http, alertify, modalService) {
                    this.http = http;
                    this.alertify = alertify;
                ...
                MahasiswaComponent.prototype.getMahasiswa = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'mahasiswa').subscribe(function (respose) {
                        _this.mahasiswas = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                MahasiswaComponent.prototype.registerToggle = function () {
                    return this.registerModeMahasiswa = true;
                };
                MahasiswaComponent.prototype.cancelRegisterMode = function (registerMode) {
                    this.registerModeMahasiswa = registerMode;
                };
                MahasiswaComponent.prototype.detailToggle = function (mahasiswaId) {
                    this.mahasiswaIdClick = mahasiswaId;
                    return this.detailModeMahasiswa = true;
                };
                MahasiswaComponent.prototype.cancelDetailMode = function (registerMode) {
                    this.detailModeMahasiswa = registerMode;
                };
                MahasiswaComponent.prototype.editToggle = function (mahasiswaId) {
                    this.mahasiswaIdClick = mahasiswaId;
                    return this.editModeMahasiswa = true;
                };
                MahasiswaComponent.prototype.cancelEditMode = function (registerMode) {
                    this.editModeMahasiswa = registerMode;
                };
                MahasiswaComponent.prototype.setMahasiswaId = function (id) {
                    this.mahasiswaIdClick = id;
                };
                MahasiswaComponent.prototype.deleteMahasiswa = function () {
                    var _this = this;
                    this.http.delete(this.baseUrl + 'mahasiswa/' + this.mahasiswaIdClick).subscribe(function () {
                        _this.alertify.success('Mahasiswa di hapus');
                        _this.getMahasiswa();
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                MahasiswaComponent.prototype.onSearchChange = function (searchValue) {
                    var _this = this;
                    if (searchValue === '') {
                        this.getMahasiswa();
                    }
                    this.http.get(this.baseUrl + 'mahasiswa/search/' + searchValue).subscribe(function (respose) {
                        _this.mahasiswas = respose;
                    }, function (error) {
                    });
                };
                MahasiswaComponent.prototype.openModal = function (template) {
                    this.modalRef = this.modalService.show(template, { class: 'modal-sm' });
                };
                MahasiswaComponent.prototype.confirm = function () {
                    this.deleteMahasiswa();
                    this.modalRef.hide();
                };
                MahasiswaComponent.prototype.decline = function () {
                    this.modalRef.hide();
                };
                return MahasiswaComponent;
            }());
            MahasiswaComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            var MataKuliahComponent = /** @class */ (function () {
                function MataKuliahComponent(http, alertify) {
                    this.http = http;
                    this.alertify = alertify;
                    this.baseUrl = 'http://localhost:5000/api/';
                    this.registerModeMatkul = false;
                }
                MataKuliahComponent.prototype.ngOnInit = function () {
                    this.getMataKuliah();
                };
                MataKuliahComponent.prototype.getMataKuliah = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'matakuliah').subscribe(function (respose) {
                        _this.matkuls = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                MataKuliahComponent.prototype.deleteMatkul = function (id) {
                    var _this = this;
                    return this.http.delete(this.baseUrl + 'matakuliah/' + id).subscribe(function () {
                        _this.alertify.error('MataKuliah Dihapus');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.getMataKuliah();
                ...
                MataKuliahComponent.prototype.registerToggle = function () {
                    return this.registerModeMatkul = true;
                };
                MataKuliahComponent.prototype.cancelRegisterMode = function (registerMode) {
                    this.registerModeMatkul = registerMode;
                };
                return MataKuliahComponent;
            }());
            MataKuliahComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            /* harmony import */ var ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-bootstrap/modal */ "./node_modules/ngx-bootstrap/modal/fesm2015/ngx-bootstrap-modal.js");
            var PerkuliahanComponent = /** @class */ (function () {
                function PerkuliahanComponent(http, alertify, modalService) {
                    this.http = http;
                    this.alertify = alertify;
                    this.modalService = modalService;
                    this.baseUrl = 'http://localhost:5000/api/';
                ...
                PerkuliahanComponent.prototype.ngOnInit = function () {
                    this.getPerkuliahan();
                };
                PerkuliahanComponent.prototype.getPerkuliahan = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'perkuliahan').subscribe(function (respose) {
                        _this.perkuliahans = respose;
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                PerkuliahanComponent.prototype.registerToggle = function () {
                    return this.registerModePerkuliahan = true;
                };
                PerkuliahanComponent.prototype.cancelRegisterMode = function (registerMode) {
                    this.registerModePerkuliahan = registerMode;
                };
                PerkuliahanComponent.prototype.editToggle = function (id) {
                    this.perkuliahanIdClick = id;
                    return this.editModePerkuliahan = true;
                };
                PerkuliahanComponent.prototype.cancelEditMode = function (editMode) {
                    this.editModePerkuliahan = editMode;
                };
                PerkuliahanComponent.prototype.setPerkuliahanId = function (id) {
                    this.perkuliahanIdClick = id;
                };
                PerkuliahanComponent.prototype.deletePerkuliahan = function () {
                    var _this = this;
                    this.http.delete(this.baseUrl + 'perkuliahan/' + this.perkuliahanIdClick).subscribe(function () {
                        _this.alertify.success('Perkuliahan di hapus');
                        _this.getPerkuliahan();
                    }, function (error) {
                        _this.alertify.error(error);
                    });
                };
                PerkuliahanComponent.prototype.openModal = function (template) {
                    this.modalRef = this.modalService.show(template, { class: 'modal-sm' });
                };
                PerkuliahanComponent.prototype.confirm = function () {
                    this.deletePerkuliahan();
                    this.modalRef.hide();
                };
                PerkuliahanComponent.prototype.decline = function () {
                    this.modalRef.hide();
                };
                return PerkuliahanComponent;
            }());
            PerkuliahanComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] },
                { type: ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_4__["BsModalService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_regis_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/regis.service */ "./src/app/_services/regis.service.ts");
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            var RegisterDosenComponent = /** @class */ (function () {
                function RegisterDosenComponent(regisService, alertify) {
                    this.regisService = regisService;
                    this.alertify = alertify;
                    this.cancelRegister = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                ...
                RegisterDosenComponent.prototype.ngOnInit = function () {
                };
                RegisterDosenComponent.prototype.register = function () {
                    var _this = this;
                    this.regisService.registerDosen(this.model).subscribe(function () {
                        _this.alertify.success('Dosen Ditambahkan');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.updateDosen.emit();
                    });
                };
                RegisterDosenComponent.prototype.cancel = function () {
                    this.cancelRegister.emit(false);
                };
                return RegisterDosenComponent;
            }());
            RegisterDosenComponent.ctorParameters = function () { return [
                { type: _services_regis_service__WEBPACK_IMPORTED_MODULE_2__["RegisService"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_regis_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/regis.service */ "./src/app/_services/regis.service.ts");
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            var RegisterMahasiswaComponent = /** @class */ (function () {
                function RegisterMahasiswaComponent(regisService, alertify) {
                    this.regisService = regisService;
                    this.alertify = alertify;
                    this.cancelRegister = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                    this.updateMahasiswa = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                ...
                RegisterMahasiswaComponent.prototype.ngOnInit = function () {
                };
                RegisterMahasiswaComponent.prototype.register = function () {
                    var _this = this;
                    this.regisService.registerMahasiswa(this.model).subscribe(function () {
                        _this.alertify.success('Mahasiswa Ditambahkan');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.updateMahasiswa.emit();
                ...
                RegisterMahasiswaComponent.prototype.cancel = function () {
                    this.cancelRegister.emit(false);
                };
                return RegisterMahasiswaComponent;
            }());
            RegisterMahasiswaComponent.ctorParameters = function () { return [
                { type: _services_regis_service__WEBPACK_IMPORTED_MODULE_2__["RegisService"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_regis_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/regis.service */ "./src/app/_services/regis.service.ts");
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            var RegisterMataKuliahComponent = /** @class */ (function () {
                function RegisterMataKuliahComponent(regisService, alertify) {
                    this.regisService = regisService;
                    this.alertify = alertify;
                    this.cancelRegister = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                ...
                RegisterMataKuliahComponent.prototype.ngOnInit = function () {
                };
                RegisterMataKuliahComponent.prototype.register = function () {
                    var _this = this;
                    this.regisService.registerMataKuliah(this.model).subscribe(function () {
                        _this.alertify.success('Dosen Ditambahkan');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.updateMatkul.emit();
                    });
                };
                RegisterMataKuliahComponent.prototype.cancel = function () {
                    this.cancelRegister.emit(false);
                };
                return RegisterMataKuliahComponent;
            }());
            RegisterMataKuliahComponent.ctorParameters = function () { return [
                { type: _services_regis_service__WEBPACK_IMPORTED_MODULE_2__["RegisService"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/alertify.service */ "./src/app/_services/alertify.service.ts");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var RegisterPerkuliahanComponent = /** @class */ (function () {
                function RegisterPerkuliahanComponent(http, regisService, alertify) {
                    this.http = http;
                    this.regisService = regisService;
                    this.alertify = alertify;
                    this.baseUrl = 'http://localhost:5000/api/';
                ...
                RegisterPerkuliahanComponent.prototype.ngOnInit = function () {
                    this.getMahasiswa();
                    this.getMataKuliah();
                    this.getDosen();
                };
                RegisterPerkuliahanComponent.prototype.register = function () {
                    var _this = this;
                    this.regisService.registerPerkuliahan(this.model).subscribe(function () {
                        _this.alertify.success('Perkuliahan Ditambahkan');
                    }, function (error) {
                        _this.alertify.error(error);
                    }, function () {
                        _this.updatePerkuliahan.emit();
                ...
                RegisterPerkuliahanComponent.prototype.getMahasiswa = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'mahasiswa').subscribe(function (respose) {
                        _this.mahasiswaModel = respose;
                    }, function (error) {
                ...
                RegisterPerkuliahanComponent.prototype.getMataKuliah = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'matakuliah').subscribe(function (respose) {
                        _this.mataKuliahModel = respose;
                    }, function (error) {
                ...
                RegisterPerkuliahanComponent.prototype.getDosen = function () {
                    var _this = this;
                    this.http.get(this.baseUrl + 'dosen').subscribe(function (respose) {
                        _this.dosenModel = respose;
                    }, function (error) {
                ...
                RegisterPerkuliahanComponent.prototype.cancel = function () {
                    this.cancelRegister.emit(false);
                };
                return RegisterPerkuliahanComponent;
            }());
            RegisterPerkuliahanComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
                { type: _services_regis_service__WEBPACK_IMPORTED_MODULE_2__["RegisService"] },
                { type: _services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"] }
            ]; };
